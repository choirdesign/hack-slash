...
struct  SimpleCollator_t1120  : public Object_t
{
	...
	CodePointIndexer_t1106 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1106 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1120_StaticFields{
	...
	SimpleCollator_t1120 * ___invariant_1;
};
