...
// EnemyControl
struct  EnemyControl_t25  : public MonoBehaviour_t2
{
	...
	Text_t26 * ___myName_8;
	// EnemyStats EnemyControl::enemyStats
	EnemyStats_t5 * ___enemyStats_9;
