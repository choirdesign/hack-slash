...
struct  ClientSessionInfo_t770  : public Object_t
{
	...
	ByteU5BU5D_t676* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t676* ___masterSecret_5;
};
struct ClientSessionInfo_t770_StaticFields{
