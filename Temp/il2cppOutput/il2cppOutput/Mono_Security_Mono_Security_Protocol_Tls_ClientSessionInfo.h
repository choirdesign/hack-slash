...
struct  ClientSessionInfo_t782  : public Object_t
{
	...
	ByteU5BU5D_t688* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t688* ___masterSecret_5;
};
struct ClientSessionInfo_t782_StaticFields{
