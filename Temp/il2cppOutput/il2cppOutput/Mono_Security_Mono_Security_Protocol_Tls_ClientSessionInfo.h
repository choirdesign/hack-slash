...
struct  ClientSessionInfo_t788  : public Object_t
{
	...
	ByteU5BU5D_t694* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t694* ___masterSecret_5;
};
struct ClientSessionInfo_t788_StaticFields{
