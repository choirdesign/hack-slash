...
struct  X509Store_t945  : public Object_t
{
	...
	X509Certificate2Collection_t939 * ___list_2;
	...
	X509Store_t745 * ___store_4;
};
struct X509Store_t945_StaticFields{
	...
	Dictionary_2_t221 * ___U3CU3Ef__switchU24mapF_5;
};
