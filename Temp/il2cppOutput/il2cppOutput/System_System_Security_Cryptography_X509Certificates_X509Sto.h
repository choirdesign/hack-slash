...
struct  X509Store_t961  : public Object_t
{
	...
	X509Certificate2Collection_t955 * ___list_2;
	...
	X509Store_t761 * ___store_4;
};
struct X509Store_t961_StaticFields{
	...
	Dictionary_2_t69 * ___U3CU3Ef__switchU24mapF_5;
};
