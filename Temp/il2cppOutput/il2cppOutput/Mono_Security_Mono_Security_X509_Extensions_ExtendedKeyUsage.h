...
struct  ExtendedKeyUsageExtension_t766  : public X509Extension_t760
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t725 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t766_StaticFields{
	...
	Dictionary_2_t69 * ___U3CU3Ef__switchU24map14_4;
};
