...
struct  ExtendedKeyUsageExtension_t750  : public X509Extension_t744
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t709 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t750_StaticFields{
	...
	Dictionary_2_t221 * ___U3CU3Ef__switchU24map14_4;
};
